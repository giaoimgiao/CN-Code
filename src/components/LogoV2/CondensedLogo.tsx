...
import { PANGU_APP_NAME } from './panguStartupContent.js';
...
export function CondensedLogo() {
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = isFullscreenEnvEnabled() ? <AnimatedClawd /> : <PanguStartupLeft compact />;
    $[7] = t4;
  } else {
    t4 = $[7];
  }
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Text bold={true}>{PANGU_APP_NAME}</Text>;
    $[8] = t5;
  } else {
    t5 = $[8];
  }
