...
export function HelpV2(t0) {
  ...
  let t1;
  if ($[0] !== onClose) {
    t1 = () => onClose(terminalZh.helpDismissResult, {
      display: "system"
    });
    $[0] = onClose;
    $[1] = t1;
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Tab key="general" id="general" title={terminalZh.helpTabGeneral}><General /></Tab>;
    $[8] = t4;
  } else {
    t4 = $[8];
  }
  ...
  if ($[9] !== antOnlyCommands || $[10] !== builtinCommands || $[11] !== close || $[12] !== columns || $[13] !== customCommands || $[14] !== maxHeight) {
    ...
    if ($[16] !== builtinCommands || $[17] !== close || $[18] !== columns || $[19] !== maxHeight) {
      t5 = <Tab key="commands" id="commands" title={terminalZh.helpTabCommands}><Commands commands={builtinCommands} maxHeight={maxHeight} columns={columns} title={terminalZh.helpBrowseBuiltin} onCancel={close} /></Tab>;
      $[16] = builtinCommands;
      $[17] = close;
      $[18] = columns;
      $[19] = maxHeight;
    ...
    if ($[21] !== close || $[22] !== columns || $[23] !== customCommands || $[24] !== maxHeight) {
      t6 = <Tab key="custom" id="custom" title={terminalZh.helpTabCustom}><Commands commands={customCommands} maxHeight={maxHeight} columns={columns} title={terminalZh.helpBrowseCustom} emptyMessage={terminalZh.helpNoCustom} onCancel={close} /></Tab>;
      $[21] = close;
      $[22] = columns;
      $[23] = customCommands;
      $[24] = maxHeight;
  ...
  let t6;
  if ($[31] !== tabs) {
    t6 = <Tabs title={false ? "/help" : terminalZh.helpTitleVersion(MACRO.VERSION)} color="professionalBlue" defaultTab="general">{tabs}</Tabs>;
    $[31] = tabs;
    $[32] = t6;
  } else {
    t6 = $[32];
  ...
  if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Box marginTop={1}><Text>{terminalZh.helpMoreDocs}{" "}<Link url="https://code.claude.com/docs/en/overview" /></Text></Box>;
    $[33] = t7;
  } else {
    t7 = $[33];
  }
  ...
  if ($[34] !== dismissShortcut || $[35] !== exitState.keyName || $[36] !== exitState.pending) {
    t8 = <Box marginTop={1}><Text dimColor={true}>{exitState.pending ? <>{terminalZh.helpPressAgainExit(exitState.keyName)}</> : <Text italic={true}>{terminalZh.helpPressToCancel(dismissShortcut)}</Text>}</Text></Box>;
    $[34] = dismissShortcut;
